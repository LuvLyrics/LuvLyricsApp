  ...
  useEffect(() => {
    const syncAudio = async () => {
      ...
      if (loadedAudioId !== currentSong.id && currentSong.audioUri) {
        try {
          if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[MiniPlayer] Syncing audio for:', currentSong.title);
          ...
          if (isInitialLoad.current) {
            ...
            if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[MiniPlayer] Initial load - staying paused');
          } else {
            setStorePlaying(true);
            player.play();
            if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[MiniPlayer] User selected song - auto-playing');
          }
        } catch (error) {
          if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('[MiniPlayer] Failed to sync audio:', error);
        }
      }
    };
