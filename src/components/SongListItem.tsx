...
export const SongListItem = React.memo(({ song, onPress, onLongPress, addToScanQueue }: SongListItemProps) => {
  ...
  const handleAddToScanQueue = useCallback(() => {
    addToScanQueue(song);
  }, [addToScanQueue, song]);
  ...
  const renderRightActions = useCallback((
    ...
    return (
      <Pressable style={styles.swipeAction} onPress={handleAddToScanQueue}>
  ...
  }, [colors.primary, handleAddToScanQueue]);
