...
export const LrcLibService = {
  ...
  search: async (params: string | { track_name?: string; artist_name?: string; album_name?: string; q?: string }): Promise<LrcLibTrack[]> => {
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[LrcLibService] Searching LRCLIB:', searchUrl);
      ...
      if (isAbortError(error)) {
         if (typeof __DEV__ !== 'undefined' && __DEV__) console.warn('[LrcLibService] Search timed out');
      } else {
         if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('[LrcLibService] Search error:', error);
      }
      return [];
    }
  },
  ...
  getLyrics: async (
    ...
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[LrcLibService] Getting lyrics from:', url);
      ...
      if (isAbortError(error)) {
         if (typeof __DEV__ !== 'undefined' && __DEV__) console.warn('[LrcLibService] GetLyrics timed out');
      } else {
         if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('[LrcLibService] GetLyrics error:', error);
      }
      return null;
    }
  },
