...
const SettingsScreen: React.FC<Props> = () => {
  ...
  const handleEditAvatar = async () => {
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Avatar selection failed:', error);
    }
  };
  ...
  const handleExport = async () => {
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Export failed:', error);
  ...
  const handleImport = async () => {
    try {
      ...
      if (count > 0) {
       ...
       if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Import failed:', error);
  ...
  const handleBatchCoverArt = async () => {
    ...
    try {
              ...
              onPress: async () => {
                ...
                for (const song of importedSongs) {
                  try {
                    ...
                    if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Failed to update:', song.title);
                  }
                }
                addRecentArt(uri);
                setAlertConfig({
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Cover art selection failed:', error);
    }
  };
    ...
    for (const audioFile of availableAudioFiles) {
      if (selectedFiles.has(audioFile.uri)) {
        try {
          ...
          if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Failed to import:', audioFile.filename, error);
        }
      }
    }
