...
const AddEditLyricsScreen = ({ navigation, route }: any) => {
  ...
  const handlePaste = async () => {
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Paste failed:', error);
    }
  };
  ...
  const handleMagicPress = async () => {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[Magic] Attempt ${magicAttempt}: Searching for "${searchTitle}" by "${searchArtist}"`);
      ...
      try {
          ...
          if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('[Magic] Error:', error);
          setMagicStatus('red');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Save failed:', error);
      Alert.alert(
        'Save Failed', 
              ...
              <View style={{ flexDirection: 'row', gap: 16 }}>
                 <Pressable onPress={() => {
                        ...
                        if (nextState && !transliteratedText && lyricsText) {
                            if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[AddEdit] Auto-generating transliteration...');
                            ...
                            if (typeof __DEV__ !== 'undefined' && __DEV__) console.log('[AddEdit] Generated text length:', resText.length);
