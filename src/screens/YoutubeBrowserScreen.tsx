...
export const YoutubeBrowserScreen = ({ navigation }: any) => {
  ...
  const handleMessage = useCallback((event: WebViewMessageEvent) => {
    try {
      ...
      if (data.type === 'AUDIO_EXTRACTED') {
        ...
        if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[YTBrowser] ✓ Audio extracted: ${data.title}`);
        if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[YTBrowser] URL: ${data.audioUrl.substring(0, 100)}...`);
        if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[YTBrowser] Bitrate: ${bitrateKbps}kbps, Format: ${ext}, Duration: ${data.lengthSeconds}s`);
        ...
        showFab();
         ...
         // Silent warning
         if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[YTBrowser] Extraction err: ${data.error}`);
      }
    } catch (e) {
  ...
  const handleDownloadPress = useCallback(() => {
    ...
    if (typeof __DEV__ !== 'undefined' && __DEV__) console.log(`[YTBrowser] Handing off: ${videoInfo.title}`);
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <WebView
          ...
          onError={(syntheticEvent) => {
            ...
            if (typeof __DEV__ !== 'undefined' && __DEV__) console.warn(`[YTBrowser] WebView error: ${nativeEvent.description}`);
