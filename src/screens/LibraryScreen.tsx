    ...
    try {
        ...
        if (uriToShare.startsWith('content://')) {
            ...
            try {
                ...
                if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Failed to copy content URI for sharing:', copyError);
        ...
        if (typeof __DEV__ !== 'undefined' && __DEV__) console.error('Share error:', error);
